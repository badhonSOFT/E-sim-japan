...
const translations = {
  EN: {
    stayConnected: 'Stay Connected Seamlessly.',
  ...
  বাং: {
    stayConnected: 'নির্বিঘ্নে সংযুক্ত থাকুন।',
...
export const StayConnectedSeamlesslyNew = () => {
  ...
  return (
    <>
      ...
      <section className="relative w-full" style={{ backgroundColor: 'white' }}>
        ...
        {/* Additional Stay Connected Seamlessly Section */}
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-12 md:py-16">
          <div className="text-center">
            <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-4" style={{ fontFamily: 'SF Pro Display, SF Pro Icons, Helvetica Neue, Helvetica, Arial, sans-serif' }}>
              {t.stayConnected}
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground" style={{ fontFamily: 'SF Pro Display, SF Pro Icons, Helvetica Neue, Helvetica, Arial, sans-serif' }}>
              Experience seamless connectivity with our advanced smart home solutions.
            </p>
          </div>
        </div>
      </section>
